...
public class ModFile implements
    ...
    public ModFile() {
        ...
        BaseMod.addColor(CharacterFile.Enums.Greener, characterColor, characterColor, characterColor,
    ...
    public void receiveEditCharacters() {
        BaseMod.addCharacter(new CharacterFile(CharacterFile.characterStrings.NAMES[1], CharacterFile.Enums.STS2Silent),
            CHARSELECT_BUTTON, CHARSELECT_PORTRAIT, CharacterFile.Enums.STS2Silent);
